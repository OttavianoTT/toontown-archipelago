...
class DistributedSuitPlannerAI(DistributedObjectAI.DistributedObjectAI, SuitPlannerBase.SuitPlannerBase):
    ...
    SuitHoodInfo = [
                    ...
                    # Minnies Melodyland
                    [4100, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (50, 0, 0, 50),  (4, 5, 6, 7), [], 5],
                    [4200, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (0, 100, 0, 0),  (4, 5, 6, 7), [], 5],
                    [4300, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (25, 0, 50, 25), (4, 5, 6, 7), [], 5],

                    # The Brrrgh
                    [3100, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (100, 0, 0, 0), (5, 6, 7, 8), [], 5],
                    [3200, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (0, 0, 50, 50), (5, 6, 7, 8), [], 5],
                    [3300, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (0, 100, 0, 0), (5, 6, 7, 8), [], 5],

                    #Donalds Dreamland
                    [9100, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (33, 34, 0, 33), (6, 7, 8, 9), [], 6],
                    [9200, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (0, 0, 100, 0),  (6, 7, 8, 9), [], 6],
                    
                    # Sellbot Courtyard & Exterior
                    [11000, 3, 15, 0, 0, 0, 4, (1, 5, 10, 40, 60, 80), (0, 0, 0, 100),  (5, 6, 7), [], 4],
                    [11200, 10, 20, 0, 0, 0, 4, (1, 5, 10, 40, 60, 80), (0, 0, 0, 100), (6, 7, 8, 9), [], 4],
                    
                    # Cashbot Courtyard
                    [12000, 10, 20, 0, 0, 0, 4, (1, 5, 10, 40, 60, 80), (0, 0, 100, 0), (6, 7, 8, 9), [], 5],
                    
                    # Lawbot Courtyard
                    [13000, 10, 20, 0, 0, 0, 4, (1, 5, 10, 40, 60, 80), (0, 100, 0, 0), (7, 8, 9, 10), [], 6],
                    
                    # Bossbot Courtyard
                    [10000, 10, 20, 0, 0, 0, 4, (1, 5, 10, 40, 60, 80), (100, 0, 0, 0), (8, 9, 10, 11), [], 6]]
    ...
    def pickLevelTypeAndTrack(self, level=None, type=None, track=None):
        ...
        if level not in ToontownGlobals.SuitLevels:
            level = min(max(level, type), type + levelRange)

...
Paths = {'sellbotFactory': {0: [Vec3(10.0, 0.0, 0.0),
 ...
 'lawOfficeStage': {28: [Vec3(-32.1953697205, -85.9077148438, 0.0),
                    ...
                    30: [Vec3(-0.175471186638, 24.0636901855, 0.0),
                         ...
                         Vec3(-34.2972984314, 58.8515930176, 0.0),
                         Vec3(-18.7033634186, 27.5550231934, 0.0)],
                    80: [Vec3(66.99, 24.6, 0.0),
                         Vec3(66.99, -9.64908, 0.0)],
                    81: [Vec3(166.919, 13.0645, 0),
                         Vec3(166.919, -12.9978, 0.0)],
                    82: [Vec3(-9.72327, 57.541, 0.0239553),
                         Vec3(16.8658, 56.7295, 0.0239553)],
                    0: [Vec3(-5, 0.0, 0.0),
                        Vec3(-5, 10.0, 0.0),
                        Vec3(5.0, 10.0, 0.0),
                        Vec3(5.0, 0.0, 0.0)],

...
GlobalEntities = {1000: {'type': 'levelMgr',
 ...
 20092: {'type': 'healBarrel',
         ...
         'rewardPerGrab': 5,
         'rewardPerGrabMax': 0},
 20119: {'type': 'apBarrel', # ARCHI BARREL PLACEMENT - WEST SILO
         'name': 'archi-1',
         'comment': '',
         'parentEntId': 0,
         'pos': Point3(-92.42, 668.19, 208.751),
         'hpr': Vec3(-30, 0, 0),
         'scale': 1,
         'apRewardIndex': 0,
         'rewardPerGrab': 5,
         'rewardPerGrabMax': 0},
 20120: {'type': 'apBarrel', # ARCHI BARREL PLACEMENT - EAST SILO
         'name': 'archi-2',
         'comment': '',
         'parentEntId': 0,
         'pos': Point3(60, 639.44, 208.695),
         'hpr': Vec3(65, 0, 0),
         'scale': 1,
         'apRewardIndex': 1,
         'rewardPerGrab': 5,
 ...
 20121: {'type': 'apBarrel',  # ARCHI BARREL PLACEMENT - WAREHOUSE
         ...
         'comment': '',
         'parentEntId': 0,
         'pos': Point3(0.9, 416.05, 28.742),
         'hpr': Vec3(155, 0.0, 0.0),

...
class DistributedAPCheckBarrelAI(DistributedBarrelBaseAI.DistributedBarrelBaseAI):
    ...
    FACILITY_BARREL_TO_AP_CHECK = {
        ...
        (ToontownGlobals.LawbotStageIntA, 2, 0): locations.ToontownLocationName.A_OFFICE_BARREL_5.value,
        (ToontownGlobals.LawbotStageIntA, 2, 1): locations.ToontownLocationName.A_OFFICE_BARREL_6.value,
        (ToontownGlobals.LawbotStageIntA, 3, 0): locations.ToontownLocationName.A_OFFICE_BARREL_7.value,
        (ToontownGlobals.LawbotStageIntA, 3, 1): locations.ToontownLocationName.A_OFFICE_BARREL_8.value,
        ...
        (ToontownGlobals.LawbotStageIntB, 2, 0): locations.ToontownLocationName.B_OFFICE_BARREL_5.value,
        (ToontownGlobals.LawbotStageIntB, 2, 1): locations.ToontownLocationName.B_OFFICE_BARREL_6.value,
        (ToontownGlobals.LawbotStageIntB, 3, 0): locations.ToontownLocationName.B_OFFICE_BARREL_7.value,
        (ToontownGlobals.LawbotStageIntB, 3, 1): locations.ToontownLocationName.B_OFFICE_BARREL_8.value,
        ...
        (ToontownGlobals.LawbotStageIntC, 2, 0): locations.ToontownLocationName.C_OFFICE_BARREL_5.value,
        (ToontownGlobals.LawbotStageIntC, 2, 1): locations.ToontownLocationName.C_OFFICE_BARREL_6.value,
        (ToontownGlobals.LawbotStageIntC, 3, 0): locations.ToontownLocationName.C_OFFICE_BARREL_7.value,
        (ToontownGlobals.LawbotStageIntC, 3, 1): locations.ToontownLocationName.C_OFFICE_BARREL_8.value,
        ...
        (ToontownGlobals.LawbotStageIntD, 2, 0): locations.ToontownLocationName.D_OFFICE_BARREL_5.value,
        (ToontownGlobals.LawbotStageIntD, 2, 1): locations.ToontownLocationName.D_OFFICE_BARREL_6.value,
        (ToontownGlobals.LawbotStageIntD, 3, 0): locations.ToontownLocationName.D_OFFICE_BARREL_7.value,
        (ToontownGlobals.LawbotStageIntD, 3, 1): locations.ToontownLocationName.D_OFFICE_BARREL_8.value,
